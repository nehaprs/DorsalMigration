...
dorsals17 <- readRDS("~/BINF/scrnaseq general/dorsal migration/full head/highUMI/stage17/seurat_output/stage17-res22.rds")
dorsals19 <- readRDS("~/BINF/scrnaseq general/dorsal migration/full head/highUMI/stage19/seurat_output/stage19-res23.rds")
...
Idents(dorsals17) = dorsals17$RNA_snn_res.2.2
dorsals17$cluster_orig = Idents(dorsals17)

Idents(dorsals19) = dorsals19$RNA_snn_res.2.3
...
clusters_keep <- c("s17_10","s17_20", "s19_4","s19_10",  "s19_22", "s21_26", "s21_32",
...
DimPlot(
  ...
  cols = c(
    "s17_20" = "red",
    "s19_10" = "blue",
    "s17_10" = "green",  "s19_4"= "yellow", "s19_22"= "gold",
    "s21_26" = "pink" , "s21_32"="purple",
