...
setwd("~/BINF/scrnaseq general/dorsal migration/full head/highUMI/integrated/all4/high_res/filt-r1")
library(readxl)
df <- read_excel("filt_r1_s19d_vs_19v.xlsx")
df2 = df[,c(2,5,6)]
...
writexl::write_xlsx( as.data.frame(gsea_reactome),"filt_r1_s19d_vs_19v.xlsx-gsea_reactome.xlsx" )


p = dotplot(gsea_reactome, showCategory = 20) +
  ggtitle("Reactome GSEA")

ggsave("filt_r1_s19d_vs_19v.xlsx-gsea_reactome.png", plot = p, width = 10, height = 12)
